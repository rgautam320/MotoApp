...
const Products = ({ location }) => {
    ...
    const { products, page, error, filteredProductCount } = useSelector((state) => state.product);
                    ...
                    <div className="row">
                        <div className="col-md-3 col-sm-6 col-12">
                            ...
                            <div className="products__priceFilter">
                                ...
                                <Slider
                                    value={value}
                                    onChange={(e, price) => setValue(price)}
                            ...
                            <div className="row my-4">
                                ...
                                {products?.map((product, ind) => (
                                    <Card
                                        product={product}
                                        key={ind}
                                        styles="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 my-3"
                                    />
                                ))}
                            </div>
