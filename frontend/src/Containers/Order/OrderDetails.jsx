                    ...
                    <div className="col-lg-5 col-md-12 col-12 ">
                        <div className="orderDetails__priceBreakup orderDetails__priceBreakup__small p-3">
                            ...
                            <h5 className="orderDetails__priceBreakup__lines row">
                                ...
                                <div className="col-5">₹ {singleOrder?.totalPrice} </div>
                            </h5>
                        </div>
                        <div className="orderDetails__priceBreakup mt-4 p-3">
                            ...
                            <div>
                                ...
                                <div className="orderDetails__info">
                                    <h4>Address:</h4>
                                    <p>{`${singleOrder?.address?.phone}, ${singleOrder?.address?.street}, ${singleOrder?.address?.city}, ${singleOrder?.address?.zip}, ${singleOrder?.address?.state}, ${singleOrder?.address?.country}`}</p>
                                </div>
                            </div>
                        </div>
                    </div>
